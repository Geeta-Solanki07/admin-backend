...
export const createAdmin = async (req, res) => {
  try {
    ...
    return sendResponse(res, 201, "Success", "Admin created successfully", data);
  } catch (error) {
...
export const listAdmins = async (req, res) => {
  try {
    ...
    return sendResponse(res, 200, "Success", "Admins fetched", {
      admins,
      total,
      page,
...
export const updateAdmin = async (req, res) => {
  try {
    ...
    // Photo update: delete old, upload new
    if (req.file) {
      if (admin.profilePic) {
        // extract publicId from URL
        const publicId = admin.profilePic
          .split("/")
          .pop()
          .split(".")[0];
    ...
    return sendResponse(res, 200, "Success", "Admin updated successfully", data);
  } catch (error) {
